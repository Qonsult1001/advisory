...
Section 1a part A (Network access) (Docker Hub + Microsoft Container Registry). You
...
> (see Section 1a part G / the scanners flag). Together: ~2.2 GB on disk, ~4 GB RAM when in use - fully on-prem,
...
4. **Point developers at the approved repo.** They pull from `<NEXUS_URL>/repository/<eco>-approved/`
 instead of the public registry - see [`docs/HOW-TO-GUIDES.md`](docs/HOW-TO-GUIDES.md) Section 6

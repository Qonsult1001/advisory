...
a clean package it reads **[OK] Approved for downloading** (green). You also see its published date,
...
**You should see:** a confirmation that it was **[OK] Sent to Intake queue**, with a note telling you to

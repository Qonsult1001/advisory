...
public class PromotionBridgeTests
{
    ...
    public static ServiceProvider BuildGate()
    {
        ...
        sc.AddSingleton<PkgFirewall.Api.Catalog.OpRiskService>();
        sc.AddSingleton<IGroqClient, GroqClient>();
        sc.AddSingleton<IResearchAgent, ClaudeResearchAgent>();
        sc.AddSingleton<PkgFirewall.Api.Integrations.IItsmNotifier, PkgFirewall.Api.Integrations.ItsmWebhook>();
...
internal sealed class TestSystemUser : PkgFirewall.Api.Auth.ICurrentUser
{
